...
Perhaps improvements could be made, such as using a linked-list-based priority queue instead of a heap-based one (this would allow for faster traversals and copying), but in it\u2019s current state the other two algorithms are superior.
